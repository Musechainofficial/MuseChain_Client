    ...
    >
      <Container>
        <Grid container lg={12} sx={{width: "100%", placeItems:"center"}}>
          <Grid item lg={4} md={4} xs={12} sx={{display: "flex", placeItems: "center", flexDirection: "row"}}>
            <Box>
              <Box component="img" src={birdImage} sx={{alignItems:"center",justifyContent:"center"}} />
              <Typography
                typography="h3"
                sx={{
                  fontWeight: 700,
